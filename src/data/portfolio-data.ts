...
export const skills = {
  "Programming Languages": [
    ...
    { name: "MATLAB", icon: "SiMatlab", color: "#E16737" },
    { name: "VHDL", icon: "SiV", color: "#3B82F6" },
  ],
  "Web Technologies": [
    ...
    { name: "three.js", icon: "SiThreedotjs", color: "#3B82F6" },
  ],
  "Libraries & Frameworks": [
    { name: "React.js", icon: "SiReact", color: "#61DAFB" },
    { name: "Django", icon: "SiDjango", color: "#092E20" },
    { name: "Flask", icon: "SiFlask", color: "#000000" },
    { name: "Next.js", icon: "SiNextdotjs", color: "#3B82F6" },
    { name: "PyTorch", icon: "SiPytorch", color: "#EE4C2C" },
    { name: "NumPy", icon: "SiNumpy", color: "#013243" },
    { name: "Pandas", icon: "SiPandas", color: "#FFCA28" },
    { name: "Matplotlib", icon: "SiPlotly", color: "#3F4F75" },
  ],
  "Tools & Platforms": [
    { name: "Git", icon: "SiGit", color: "#F05032" },
    { name: "GitHub", icon: "SiGithub", color: "#3B82F6" },
...
export const publications = [
  {
    ...
    year: "2024",
    link: "https://ijisae.org/index.php/IJISAE/article/view/4980",
    description:
